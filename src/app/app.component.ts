...
export class AppComponent implements OnInit, OnDestroy {
  ...
  private buildReaderPages(days:any[],trip:any){
    ...
    const scrapbookDays=days.map((day,index)=>{
      ...
      const design={...this.defaultScrapbookDesign(),...(day.design??{})};return{kind:'day',number:index+1,...day,title,layout:'scrapbook',design,composition:design.composition||['polaroid','postcard','ticket','contact'][index%4]};
    });
