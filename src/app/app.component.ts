...
export class AppComponent implements OnInit, OnDestroy {
  ...
  async openJournal(day: TripDay) {
    ...
    this.selectedDay = day;this.cancelExpenseEdit();this.journalEditing=false;this.journalStep=1; this.journal = { title: '', summary: '', rawText: '', layout: 'scrapbook', coverMediaId: '', status: 'draft', events: [], places: [] }; this.journalMedia = []; this.go('journal');
    try {
